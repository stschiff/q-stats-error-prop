...
which yields a Z score of `r (q1[1] - 0.75) / q1[2]` or a p-value of `r pnorm((q1[1] - 0.75), sd=q1[2])`
...
which gives a Z-score of deviating from 0.75 of `r (q2[1] - 0.75) / q2[2]` and p-value of `r pnorm((q2[1] - 0.75), sd=q2[2])`, which isn't quite what's reported in @Keinan2009-ej (they report $p=3.0\times 10^{-8}$), but not too far off.
